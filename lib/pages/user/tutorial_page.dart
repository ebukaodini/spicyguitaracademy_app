...
class TutorialPageState extends State<TutorialPage>{
  ...
  void initState() {
    super.initState();
    // message(video);
    print('${App.appurl}/storage/public/tutorials/videos/a23de81.mp4');
    _controller = VideoPlayerController.network('${App.appurl}/storage/public/tutorials/videos/a23de81.mp4')
      ..initialize().then((_) {
            setState(() {});
      });
  }
                        ...
                        : Container(
                          ...
                          decoration: new BoxDecoration(
                            image: new DecorationImage(
                              image: NetworkImage('${App.appurl}/$thumbnail'),
                              fit: BoxFit.fitWidth,
                            ),
                            borderRadius: BorderRadius.all(Radius.circular(25)),
                          ),
